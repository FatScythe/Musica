...
import user4 from "../../images/Ellipse 4.png";
import user5 from "../../images/Ellipse 5.png";
import user6 from "../../images/Ellipse 6.png";
    ...
    <>
      <div className='card'>
        <div className='card1'>
          ...
          <div className='flex flex-col justify-evenly gap-y-2 md:justify-around basis-4/5'>
            <div className='sub-title'>
              <div className='hero-txt'>
                <h2 className='text-lg font-semibold'>R & B Hits</h2>
                <p>
            ...
            <div className='likes'>
              <div className='ml-3'>
                ...
                <span>
                  <img src={user5} alt='users' />
                </span>
                <span>
                  <img src={user6} alt='users' />
                </span>
